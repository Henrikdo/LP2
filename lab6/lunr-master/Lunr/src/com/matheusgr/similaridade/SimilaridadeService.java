...
public class SimilaridadeService {
	...
	public double similaridade(String docId1, String docId2) {
		...
		String d1 = this.documentoService.recuperaDocumento(docId1).toString();
		String d2 = this.documentoService.recuperaDocumento(docId2).toString();
		...
		double Similaridade = inter.size() / (conjunto1.size() + conjunto2.size());
		// PEGA DOCUMENTO 1
		// PEGA DOCUMENTO 2
